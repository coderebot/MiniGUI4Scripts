...
static char* config_str[][2]=
{
    {"fgc_window",              (char*)NCS_FGC_WINDOW}, 
    {"bgc_window",              (char*)NCS_BGC_WINDOW}, 
    {"fgc_3dbody",              (char*)NCS_FGC_3DBODY}, 
    {"bgc_3dbody",              (char*)NCS_BGC_3DBODY}, 
    {"metrics_3dbody_round_radius",   (char*)NCS_METRICS_3DBODY_ROUND_RADIUS}, 
    {"metrics_3dbody_roundx",   (char*)NCS_METRICS_3DBODY_ROUNDX}, 
    {"metrics_3dbody_roundy",   (char*)NCS_METRICS_3DBODY_ROUNDY}, 

    {"fgc_selected_item",       (char*)NCS_FGC_SELECTED_ITEM}, 
    {"bgc_selected_item",       (char*)NCS_BGC_SELECTED_ITEM}, 

    {"fgc_hilight_item",        (char*)NCS_FGC_HILIGHT_ITEM}, 
    {"bgc_hilight_item",        (char*)NCS_BGC_HILIGHT_ITEM}, 

    {"fgc_disabled_item",       (char*)NCS_FGC_DISABLED_ITEM}, 
    {"bgc_disabled_item",       (char*)NCS_BGC_DISABLED_ITEM}, 
    
    {"bgc_selected_nofocus",    (char*)NCS_BGC_SELITEM_NOFOCUS}, 

    {"bgc_pb_chunk",            (char*)NCS_BGC_PRGBAR_CHUNK}, 

    {"bgc_tb_slider",           (char*)NCS_BGC_TRKBAR_SLIDER}, 

//    {"bgc_tb_thumb",            (char*)NCS_BGC_TRKBAR_THUMB}, 
    {"bgc_normal_tab",          (char*)NCS_BGC_PRPSHT_NMLTAB}, 

    {"mode_bgc",                (char*)NCS_MODE_BGC},
    {"mode_bkimage",            (char*)NCS_MODE_BKIMAGE},
    {"mode_fgc",                (char*)NCS_MODE_FGC},

	{"mode_item",               (char*)NCS_MODE_ITEM},

 /*   {"mode_selected_item",      (char*)NCS_MODE_SELECTED_ITEM},
    {"mode_hilight_item",       (char*)NCS_MODE_HILIGHT_ITEM},
    {"mode_disabled_item",      (char*)NCS_MODE_DISABLED_ITEM},
*/
    {"mode_useflat",            (char*)NCS_MODE_USEFLAT},

    {"image_bkgnd",             (char*)NCS_IMAGE_BKGND},
    {"image_arrows",            (char*)NCS_IMAGE_ARROWS},
    {"image_arrowshell",        (char*)NCS_IMAGE_ARROWSHELL},

    {"image_pushbutton",        (char*)NCS_IMAGE_BUTTON},
    {"image_checkbutton",       (char*)NCS_IMAGE_CHKBTN},
    {"image_radiobutton",       (char*)NCS_IMAGE_RDOBTN},

    {"image_tree",              (char*)NCS_IMAGE_LISTV_TREE},
    {"image_header",            (char*)NCS_IMAGE_LISTV_HDR},
    {"image_tab",               (char*)NCS_IMAGE_PRPSHT_TAB},

    {"image_pb_hchunk",         (char*)NCS_IMAGE_PRGBAR_HCHUNK},
    {"image_pb_vchunk",         (char*)NCS_IMAGE_PRGBAR_VCHUNK},
    {"image_pb_hslider",        (char*)NCS_IMAGE_PRGBAR_HSLIDER},
    {"image_pb_vslider",        (char*)NCS_IMAGE_PRGBAR_VSLIDER},

    {"image_tb_hslider",        (char*)NCS_IMAGE_TRKBAR_HSLIDER},
    {"image_tb_vslider",        (char*)NCS_IMAGE_TRKBAR_VSLIDER},
    {"image_tb_hthumb",         (char*)NCS_IMAGE_TRKBAR_HTHUMB},
    {"image_tb_vthumb",         (char*)NCS_IMAGE_TRKBAR_VTHUMB},
};
...
static void _init_macro_idtable(void)
{
    ...
    for (i = 0; i < sizeof(config_str)/sizeof(char*[2]); i++) {
        msg = (we_attr_id_t*)calloc(1, sizeof(we_attr_id_t));
        memcpy(msg->str, config_str[i][0], strlen(config_str[i][0]) + 1);
        msg->id = (int)config_str[i][1];
...
static void _load_rdr_hash_table (ETC_S *pEtc, const char* rdrname)
{
    PETCSECTION psect;
    int i = 0, j = 0, id;
    char name[32];
...
GHANDLE ncsLoadRdrEtcFile (const char* etcfile, const char** rdrname, int count)
{
    ...
    for (i = 0; i < count; i++) {
        _load_rdr_hash_table(pEtc, rdrname[i]);
    }
...
MGNCS_EXPORT BOOL ncsLoadRdrElementsFromEtcFile(const char* etcfile, const char** rdrNames, int count)
{
    GHANDLE hEtc;
    BOOL bRet;
    ...
    bRet = ncsLoadRdrElementsFromEtcHandle(hEtc, rdrNames,count);
    UnloadEtcFile(hEtc);
    return bRet;
}

MGNCS_EXPORT BOOL ncsLoadRdrElementsFromEtcHandle(GHANDLE hEtc, const char** rdrNames, int count)
{
    int i;
    ...
    {
        if(rdrNames[i])
            _load_rdr_hash_table((ETC_S*)hRdrEtcFile, rdrNames[i]);
    }
    return count > 0;
}
