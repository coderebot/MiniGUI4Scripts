/*
** $Id: ial.c 13507 2010-09-27 03:13:57Z wanzheng $
** 
...
#endif
#ifdef __ANDROID__
extern BOOL InitAndroidInput(INPUT*, const char* mdev, const char* mtype);
extern TermAndroidInput(void);
#endif
...
#endif
#ifdef __ANDROID__
    {"and-bmp", InitAndroidInput, TermAndroidInput},
#endif
